          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 text-navy-400">
                  <svg className="w-5 h-5 mt-0.5 flex-shrink-0 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span className="text-sm">6132 Wilshire Blvd, Los Angeles, CA 90048</span>
                </div>
              </div>
            </div>
